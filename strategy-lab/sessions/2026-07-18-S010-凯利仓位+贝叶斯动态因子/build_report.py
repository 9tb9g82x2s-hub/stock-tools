#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""S010 report.html 生成器 —— 读取 results.json 生成可视化报告"""
import json
import os
...
<body>
<h1>S010 凯利仓位+贝叶斯动态因子</h1>
<p class="sub">33特征 · BayesianRidge贝叶斯回归 · 样本外置信度校准仓位 · 月度调仓 · 回测区间 {aux.get('first_rebalance','-')} ~ {aux.get('last_rebalance','-')}</p>
...
<div class="ft">S010 策略实验室 · BayesianRidge(贝叶斯线性回归) · 两层凯利仓位管理 · 生成于本地</div>
